...
interface FlowingMenuProps {
  ...
  borderColor?: string;
  onItemHover?: (item: MenuItemData, index: number) => void;
  onItemLeave?: (item: MenuItemData, index: number) => void;
      ...
      <nav className="flex flex-col h-full m-0 p-0">
        {items.map((item, idx) => (
          <MenuItem
            ...
            isFirst={idx === 0}
            onHover={onItemHover ? () => onItemHover(item, idx) : undefined}
            onLeave={onItemLeave ? () => onItemLeave(item, idx) : undefined}
